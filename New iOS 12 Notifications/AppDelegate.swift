...
// import to support notifications
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Before your app can send any type of notification,
        // you have to request the permission from the user to do so.
        // Remember to "Request only the authorization options that you
        // plan to use," including "The ability to post noninterrupting
